...
@Query("select new peaksoft.dtohomework.dto.houseDto.response.HouseResponse"+"(h.id,h.address,h.price,h.room,h.country,h.description,h.houseType,h.active)FROM House h WHERE h.active = false")
